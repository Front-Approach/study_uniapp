...
var t1=_mz(z,'swiper',['autoplay',1,'class',1,'duration',2,'indicatorDots',3,'interval',4],[],e,s,gg)
var e2=_v()
_(t1,e2)
var b3=function(x5,o4,o6,gg){
var c8=_n('swiper-item')
var h9=_mz(z,'image',['alt',-1,'class',9,'src',1,'style',2],[],x5,o4,gg)
_(c8,h9)
_(o6,c8)
return o6
}
e2.wxXCkey=2
_2z(z,8,b3,e,s,gg,e2,'item','__i0__','')
_(aZ,t1)
_(r,aZ)
return r
}
...
var oBB=_n('swiper')
_(cAB,oBB)
var lCB=_mz(z,'nav-btn',['bind:__l',1,'vueId',1],[],e,s,gg)
_(cAB,lCB)
_(r,cAB)
return r
}
...
var bGB=_mz(z,'image',['mode',-1,'src',2],[],e,s,gg)
_(eFB,bGB)
_(tEB,eFB)
var oHB=_n('view')
_rz(z,oHB,'class',3,e,s,gg)
var xIB=_mz(z,'image',['mode',-1,'src',4],[],e,s,gg)
_(oHB,xIB)
_(tEB,oHB)
_(r,tEB)
return r
...
var oPB=_mz(z,'image',['mode',-1,'src',1],[],e,s,gg)
_(cOB,oPB)
_(r,cOB)
return r
}
...
__wxAppCode__['components/NavBtn.wxss']=setCssToHead([".",[1],"out{width: ",[0,480],";margin: 0 auto;display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-flex-flow:wrap;-ms-flex-flow:wrap;flex-flow:wrap;-webkit-box-pack: justify;-webkit-justify-content: space-between;-ms-flex-pack: justify;justify-content: space-between}\n.",[1],"out-line{width: ",[0,480],";margin: 0 auto;display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex;-webkit-flex-flow:wrap;-ms-flex-flow:wrap;flex-flow:wrap;-webkit-box-pack: justify;-webkit-justify-content: space-between;-ms-flex-pack: justify;justify-content: space-between;margin-top: ",[0,80],";}\n.",[1],"index-icon{width: ",[0,160],";height: ",[0,200],";text-align: center;padding: ",[0,0],";}\n.",[1],"index-icon .",[1],"img{width: ",[0,160],";height: ",[0,160],";}\n.",[1],"index-icon wx-image{width: ",[0,160],";height: ",[0,160],";}\n.",[1],"index-icon wx-text{font-size: ",[0,28],";text-align: center;color: #828081;}\n",],undefined,{path:"./components/NavBtn.wxss"});    
__wxAppCode__['components/NavBtn.wxml']=$gwx('./components/NavBtn.wxml');

__wxAppCode__['components/Swiper.wxss']=setCssToHead([".",[1],"swiper-w{ width: 100%; }\n.",[1],"swiper { height: ",[0,450],"; width: 100%; }\n.",[1],"swiper-item { height: 100%; width: 100%; }\n.",[1],"swiper-item .",[1],"image { height: 100%; width: 100%; }\n",],undefined,{path:"./components/Swiper.wxss"});    
...
__wxAppCode__['pages/maintenance/maintenance.wxss']=undefined;    
...
__wxAppCode__['pages/start/start.wxss']=setCssToHead(["body{width: 100%;height: 100%;}\n.",[1],"start{width: calc(100%);height: calc(100%);display: block;}\n.",[1],"start wx-image{width: 100%;height: 100%;}\n",],undefined,{path:"./pages/start/start.wxss"});    
